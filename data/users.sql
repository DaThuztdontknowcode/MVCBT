CREATE TABLE `tbl_users` (
  ...
  `email` VARCHAR(1024),
  `address.street` VARCHAR(1024),
  `address.suite` VARCHAR(1024),
  `address.city` VARCHAR(1024),
  `address.zipcode` VARCHAR(1024),
  `address.geo.lat` VARCHAR(1024),
  `address.geo.lng` VARCHAR(1024),
  `phone` VARCHAR(1024),
  `website` VARCHAR(1024),
  `company.name` VARCHAR(1024),
  `company.catchPhrase` VARCHAR(1024),
  `company.bs` VARCHAR(1024)
);
